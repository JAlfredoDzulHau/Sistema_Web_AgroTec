...
<head>
	...
	<title>AgroTec | Lista de usuarios</title>
...
<body>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT u.id_usuario, u.nombre, u.usuario, r.rol FROM usuarios u INNER JOIN rol r ON u.rol = r.id_rol WHERE estatus = 1 ORDER BY u.id_usuario ASC LIMIT $desde,$por_pagina 
				");
