    ...
    <tbody>
      ...
      <?php foreach($result as $fila);?>
        <tr>
          ...
          <a class="boton_personalizado" href="edit01.php?id=<?php echo $id='5'; ?>" class="center">Editar información del Terreno</a>
          </th>
</tr><tr>
          ...
          <td rowspan="5">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4451.007083032542!2d-90.17861618430298!3d20.265639360381446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f861a77ea248fd%3A0xe54d7e323954a4b1!2sChunhu%C3%A1s%2C%20Camp.!5e0!3m2!1ses!2smx!4v1610698183235!5m2!1ses!2smx" width="400" height="250" frameborder="0" style="border:1;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </td>
        </tr>
        <tr>
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT COUNT(*) total FROM chunhuas";
...
<!-- template para el snackbar-->
   ...
   <!--  <template>
      <v-card height="40" class="mx-4 mt-3">
        ...
        <script src="main_terreno/main_ChunHuas.js"></script>
    </body>
    <?php } ?>
</html>
