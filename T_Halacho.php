    ...
    <tbody>
      ...
      <?php foreach($result as $fila);?>
        <tr>
          ...
          <a class="boton_personalizado" href="edit01.php?id=<?php echo $id='9'; ?>" class="center">Editar información del Terreno</a>
          </th>
</tr><tr>
          ...
          <td rowspan="5">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29900.753738609714!2d-90.09818211591906!3d20.481853175840794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f88486920920cd%3A0x76eb64086208fb6a!2zSGFsYWNow7MsIFl1Yy4!5e0!3m2!1ses!2smx!4v1610698754873!5m2!1ses!2smx" width="400" height="250" frameborder="0" style="border:1;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </td>
        </tr>
        <tr>
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT COUNT(*) total FROM halacho";
...
<!-- template para el snackbar-->
   ...
   <!--  <template>
      <v-card height="40" class="mx-4 mt-3">
        ...
        <script src="main_terreno/main_Halacho.js"></script>
    </body>
    <?php } ?>
</html>
