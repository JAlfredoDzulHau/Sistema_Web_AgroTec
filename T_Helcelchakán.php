    ...
    <tbody>
      ...
      <?php foreach($result as $fila);?>
        <tr>
          ...
          <a class="boton_personalizado" href="edit01.php?id=<?php echo $id='4'; ?>" class="center">Editar información del Terreno</a>
          </th>
</tr><tr>
          ...
          <td rowspan="5"> 
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29959.518459901505!2d-90.15322696625117!3d20.17823156560837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f87adb358cf54d%3A0x1039b4eeb7b02c74!2sHecelchak%C3%A1n%2C%20Camp.!5e0!3m2!1ses!2smx!4v1610698085692!5m2!1ses!2smx" width="400" height="250" frameborder="0" style="border:1;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </td>
        </tr>
        <tr>
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT COUNT(*) total FROM helcelchakan";
...
<!-- template para el snackbar-->
   ...
   <!--  <template>
      <v-card height="40" class="mx-4 mt-3">
        ...
        <script src="main_terreno/main_Helcelchakán.js"></script>
    </body>
    <?php } ?>
</html>
