    ...
    <tbody>
      ...
      <?php foreach($result as $fila);?>
        <tr>
          ...
          <a class="boton_personalizado" href="edit01.php?id=<?php echo $id='7'; ?>" class="center">Editar información del Terreno</a>
          </th>
</tr><tr>
          ...
          <td rowspan="5"> 
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14894.600387149989!2d-89.04791658141228!3d21.046682052124538!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f56a0e0d912e697%3A0xbc23bc97e243d7c3!2zVGVwYWvDoW4sIFl1Yy4!5e0!3m2!1ses!2smx!4v1610698424782!5m2!1ses!2smx" width="400" height="250" frameborder="0" style="border:1;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </td>
        </tr>
        <tr>
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT COUNT(*) total FROM tepakan";
...
<!-- template para el snackbar-->
   ...
   <!--  <template>
      <v-card height="40" class="mx-4 mt-3">
        ...
        <script src="main_terreno/main_Tepakan.js"></script>
    </body>
    <?php } ?>
</html>
