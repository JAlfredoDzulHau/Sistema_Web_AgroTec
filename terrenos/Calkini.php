...
<?php 
  ...
  $sentencia_select=$conexion->prepare('SELECT *FROM dat_terreno');
  ...
  <body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
         <?php include "../barra_lateral_terreno.php"; ?>
    ...
    <tbody>
      ...
      <?php foreach($result as $fila);?>
        <tr>
          ...
          <a class="boton_personalizado" href="../edit01.php?id=<?php echo $fila['id']; ?>" class="center">Editar información del Terreno</a>
          </th>
</tr><tr>
          ...
          <td rowspan="5">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29922.953766924216!2d-90.06660286604465!3d20.367661009723477!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f880ee788c989f%3A0x6b22acdc8c1e562f!2zQ2Fsa2luw60sIENhbXAuLCBNw6l4aWNv!5e0!3m2!1ses-419!2sus!4v1608680532000!5m2!1ses-419!2sus" width="400" height="250" frameborder="0" style="border:1;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </td>
        </tr>
        <tr>
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT COUNT(*) total FROM terrenos";
...
<!-- template para el snackbar-->
   ...
   <!--  <template>
      <v-card height="40" class="mx-4 mt-3">
        ...
        <!--Axios -->      
        <script src="../js_tablas/axios_2.js"></script>     
        <script src="../mainTerreno.js"></script>
    </body>
    <?php } ?>
</html>
